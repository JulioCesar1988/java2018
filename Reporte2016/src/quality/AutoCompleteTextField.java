...
public class AutoCompleteTextField extends JTextField implements KeyListener,
  ...
  public void addAllPossibilitys(ArrayList<String> possibilitys) {
      this.possibilities=possibilitys;
      Collections.sort(possibilities);
  }
  ...
  public void paintComponent(Graphics g) {
      ...
      if (entered != null && !(entered.equals("")) 
          ...
          g.drawString(" " + subGuess + "   press ENTER to fill", (int)(enteredBounds.getWidth()) + 2, centeredY - 2);
      }
  }
